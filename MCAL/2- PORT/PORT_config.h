...
#define PORTC_PIN1_INIT_VALUE 		 HIGH
#define PORTC_PIN2_INIT_VALUE        HIGH
#define PORTC_PIN3_INIT_VALUE        HIGH
...
#define PORTD_PIN0_INIT_VALUE        PULLEDUP
#define PORTD_PIN1_INIT_VALUE		 PULLEDUP
#define PORTD_PIN2_INIT_VALUE        PULLEDUP
#define PORTD_PIN3_INIT_VALUE        PULLEDUP
#define PORTD_PIN4_INIT_VALUE        PULLEDUP
#define PORTD_PIN5_INIT_VALUE        PULLEDUP
#define PORTD_PIN6_INIT_VALUE        PULLEDUP
#define PORTD_PIN7_INIT_VALUE        PULLEDUP
